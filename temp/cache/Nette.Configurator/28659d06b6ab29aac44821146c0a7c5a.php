<?php
// source: C:\xampp1\htdocs\TULBook\app/config/config.neon 
// source: C:\xampp1\htdocs\TULBook\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'app\\model\\modelcontainer' => array(
				'22_App_Model_ApartmentModel',
				'23_App_Model_UserManager',
			),
			'app\\model\\apartmentmodel' => array('22_App_Model_ApartmentModel'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\xampp1\\htdocs\\TULBook\\app',
			'wwwDir' => 'C:\\xampp1\\htdocs\\TULBook\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\xampp1\\htdocs\\TULBook\\app/../temp',
		));
	}


	/**
	 * @return App\Model\ApartmentModel
	 */
	public function createService__22_App_Model_ApartmentModel()
	{
		$service = new App\Model\ApartmentModel($this->getService('nette.database.default.context'));
		return $service;
	}
	...
	{
		$service = new App\Model\UserManager($this->getService('nette.database.default.context'), $this->getService('22_App_Model_ApartmentModel'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\xampp1\\htdocs\\TULBook\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\xampp1\\htdocs\\TULBook\\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=tulbook_webowna_cz', 'root', NULL, array('lazy' => TRUE));
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('C:\\xampp1\\htdocs\\TULBook\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\xampp1\\htdocs\\TULBook\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\xampp1\\htdocs\\TULBook\\app/../temp/cache', $this->getService('nette.cacheJournal'));
