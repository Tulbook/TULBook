...
list($_b, $_g, $_l) = $template->initialize('6157700638', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb371a754a1d_content')) { function _lb371a754a1d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbbfdb3bd684_title')) { function _lbbfdb3bd684_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb66b7ad48e3_scripts')) { function _lb66b7ad48e3_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb33453fc21e_head')) { function _lb33453fc21e_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
