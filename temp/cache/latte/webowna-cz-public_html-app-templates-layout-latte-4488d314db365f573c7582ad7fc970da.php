<?php
// source: /var/home/tulbook.webowna.cz/domains/demo.tulbook.webowna.cz/public_html/app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3455863298', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb8affd71f72_head')) { function _lb8affd71f72_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb34c97ad2cd_scripts')) { function _lb34c97ad2cd_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
