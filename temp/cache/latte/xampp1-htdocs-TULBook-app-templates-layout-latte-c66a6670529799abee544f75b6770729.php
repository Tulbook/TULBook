<?php
// source: C:\xampp1\htdocs\TULBook\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('0014795116', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb3e66829acb_head')) { function _lb3e66829acb_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbf84054ea6c_scripts')) { function _lbf84054ea6c_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
